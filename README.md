...
Green's functions (GF2D.exe and GF3D.exe): `make green`  
-------------------------------------------------------
...
convertImg (convert.exe): `make convert`  
----------------------------------------
...
extractRange (range.exe): `make range`  
--------------------------------------
...
statsParams (params.exe): `make params`  
---------------------------------------
